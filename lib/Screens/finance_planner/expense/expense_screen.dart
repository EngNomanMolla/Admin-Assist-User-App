...
class ExpenseScreen extends StatelessWidget {
  ...
  Widget _buildTransactionsTab(ExpenseController controller) {
    return Column(
      children: [
  ...
  Widget _buildCategoryFilters(ExpenseController controller) {
    return Obx(() {
      return SizedBox(
        height: 40,
  ...
  Widget _buildChip({required String label, required String categoryId, required ExpenseController controller}) {
    return Obx(() {
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const Icon(Icons.money_off_rounded, color: Colors.white, size: 24),
          ],
        ),
      );
    });
  ...
  Widget _buildCategoryTab(ExpenseController controller, BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 16),
        Padding(
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.folder_rounded, color: Color(0xFFEF4444), size: 16),
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                        child: Text(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.category_rounded, color: Color(0xFFEF4444), size: 20),
                    ),
  ...
  void _showUpdateCategoryDialog(BuildContext context, ExpenseController controller, ExpenseCategory category) {
  ...
  void _showAddTransactionDialog(BuildContext context, ExpenseController controller) {
  ...
  void _showUpdateTransactionDialog(BuildContext context, ExpenseController controller, ExpenseTransaction transaction) {
